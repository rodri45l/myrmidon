...
LOCK TABLES `AppointmentUser` WRITE;
...
('string','string','2023-01-16 06:32:34','string','string',1,'string',0,'08daf78b-7ead-4887-8334-be94870d4a8f','string','STRING','string@sdaf.com','STRING@SDAF.COM',0,'AQAAAAIAAYagAAAAENSd5J7LGOnJnpbvTjnQVCX6RIkmQfAQ0hPBQu+fwkWnqSNvNyBneZfVX8b3bGYUMg==','GRY5EI6FTH3FOJUU2QT7FFWXQDPIGKBQ','005d4aed-6e0a-41ea-a67e-d6d86e65827a','string',0,0,NULL,1,0);
...
('20230115171125_IdentityUserMigration','7.0.2'),
